...
public class World
{
    ...
    public World(GameMap map, Player player, String currPlayerAreaId, HashMap<String, Area> areaIdToArea, HashMap<String, Item> itemIdToItem, HashMap<String, List<Connection>> areaIdToConnection)
    {
        this.map = map;
        this.player = player;
